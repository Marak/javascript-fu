...
for(var method in fuMethods){
  ...
  {
  case 'ge':
    docs.getFu += ( '<li>fu.' + fuMethods[method] + '( value )</li>');
  break;
  case 'is':
    docs.isFu += ( '<li>fu.' + fuMethods[method] + '( value )</li>');
  break;
  case 'fo':
    docs.formatFu += ( '<li>fu.' + fuMethods[method] + '( value, mask )</li>');
  break;
  case 'to':
    docs.toFu += ( '<li>fu.' + fuMethods[method] + '( arg )</li>');
  break;
  default:
